...
/***/ "./dist/src/routes/menu-management/get-menu-by-path.js":
/*!*************************************************************!*\
  !*** ./dist/src/routes/menu-management/get-menu-by-path.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports[\"default\"] = default_1;\nconst fetch_menu_1 = __webpack_require__(/*! ../../utils/fetch-menu */ \"./dist/src/utils/fetch-menu.js\");\nconst errors_1 = __webpack_require__(/*! ../../errors */ \"./dist/src/errors.js\");\nconst zod_1 = __webpack_require__(/*! zod */ \"zod\");\nasync function default_1(app) {\n    app.get('/menu-by-path/:path', async (req, res) => {\n        const paramSchema = zod_1.z.object({ path: zod_1.z.string() });\n        const { path } = paramSchema.parse(req.params);\n        const menu = await (0, fetch_menu_1.get_menu_from_path)(path);\n        if (!menu)\n            throw new errors_1.NotFoundError('Menu not found.');\n        delete menu.username;\n        delete menu.password;\n        return res.status(200).send({ menu });\n    });\n}\n\n\n//# sourceURL=webpack://v-menu/./dist/src/routes/menu-management/get-menu-by-path.js?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.get_menu = get_menu;\nexports.get_menu_from_session = get_menu_from_session;\nexports.get_menu_from_path = get_menu_from_path;\nexports.get_menu_from_category = get_menu_from_category;\nexports.get_menu_from_subcategory = get_menu_from_subcategory;\nexports.get_menu_from_item = get_menu_from_item;\nconst { PrismaClient } = __webpack_require__(/*! @prisma/client */ \"@prisma/client\");\nconst prisma = new PrismaClient();\nasync function get_menu(id) {\n    return await prisma.menu.findUnique({\n        where: { id },\n        include: {\n            categories: {\n                orderBy: { pos: 'asc' },\n                include: {\n                    subcategories: {\n                        orderBy: { pos: 'asc' },\n                        include: {\n                            items: {\n                                orderBy: { pos: 'asc' }\n                            }\n                        }\n                    }\n                }\n            }\n        }\n    });\n}\nasync function get_menu_from_session(id) {\n    return (await prisma.session.findUnique({\n        where: { id },\n        include: {\n            menu: {\n                include: {\n                    categories: {\n                        orderBy: { pos: 'asc' },\n                        include: {\n                            subcategories: {\n                                orderBy: { pos: 'asc' },\n                                include: {\n                                    items: {\n                                        orderBy: { pos: 'asc' }\n                                    }\n                                }\n                            }\n                        }\n                    }\n                }\n            }\n        }\n    }))?.menu;\n}\nasync function get_menu_from_path(path) {\n    return await prisma.menu.findFirst({\n        where: { path },\n        include: {\n            categories: {\n                orderBy: { pos: 'asc' },\n                include: {\n                    subcategories: {\n                        orderBy: { pos: 'asc' },\n                        include: {\n                            items: {\n                                orderBy: { pos: 'asc' }\n                            }\n                        }\n                    }\n                }\n            }\n        }\n    });\n}\nasync function get_menu_from_category(id) {\n    return (await prisma.category.findUnique({\n        where: { id },\n        include: {\n            menu: {\n                include: {\n                    categories: {\n                        orderBy: { pos: 'asc' },\n                        include: {\n                            subcategories: {\n                                orderBy: { pos: 'asc' },\n                                include: {\n                                    items: {\n                                        orderBy: { pos: 'asc' }\n                                    }\n                                }\n                            }\n                        }\n                    }\n                }\n            }\n        }\n    })).menu;\n}\nasync function get_menu_from_subcategory(id) {\n    return (await prisma.subcategory.findUnique({\n        where: { id },\n        include: {\n            category: {\n                include: {\n                    menu: {\n                        include: {\n                            categories: {\n                                orderBy: { pos: 'asc' },\n                                include: {\n                                    subcategories: {\n                                        orderBy: { pos: 'asc' },\n                                        include: {\n                                            items: {\n                                                orderBy: { pos: 'asc' }\n                                            }\n                                        }\n                                    }\n                                }\n                            }\n                        }\n                    }\n                }\n            }\n        }\n    })).category.menu;\n}\nasync function get_menu_from_item(id) {\n    return (await prisma.item.findUnique({\n        where: { id },\n        include: {\n            subcategory: {\n                include: {\n                    category: {\n                        include: {\n                            menu: {\n                                include: {\n                                    categories: {\n                                        orderBy: { pos: 'asc' },\n                                        include: {\n                                            subcategories: {\n                                                orderBy: { pos: 'asc' },\n                                                include: {\n                                                    items: {\n                                                        orderBy: { pos: 'asc' }\n                                                    }\n                                                }\n                                            }\n                                        }\n                                    }\n                                }\n                            }\n                        }\n                    }\n                }\n            }\n        }\n    })).subcategory.category.menu;\n}\n\n\n//# sourceURL=webpack://v-menu/./dist/src/utils/fetch-menu.js?");

/***/ }),

/***/ "./dist/src/utils/render.js":
/*!**********************************!*\
  !*** ./dist/src/utils/render.js ***!
  \**********************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.ssr_render = ssr_render;\n__webpack_require__(/*! svelte/register */ \"svelte/register\");\nconst fs_1 = __importDefault(__webpack_require__(/*! fs */ \"fs\"));\nconst context = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module 'undefined'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nfunction ssr_render(menu) {\n    const App = context(`./${menu.path}/Menu.svelte`).default;\n    const result = App.render({ menu });\n    fs_1.default.writeFileSync(`./public/m/${menu.path}/index.html`, `<!DOCTYPE html>\n  <html lang=\"en\">\n    <head>\n    \t<meta charset='utf-8'>\n    \t<meta name='viewport' content='width=device-width,initial-scale=1'>\n    \t<link rel='stylesheet' href='../../assets/css/global.css'>\n    \t<title> ${menu.name} </title>\n      ${result.head}\n      <style> ${result.css.code} </style>\n    </head>\n    <body> ${result.html} </body>\n  </html>`);\n}\n\n\n//# sourceURL=webpack://v-menu/./dist/src/utils/render.js?");
...
/***/ "svelte/register":
/*!**********************************!*\
  !*** external "svelte/register" ***!
  \**********************************/
/***/ ((module) => {

"use strict";
module.exports = require("svelte/register");

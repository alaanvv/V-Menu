<div class='root'>
  <div class='background'>
    <main>
      <img class='banner' src={`/img/${menu.id}/banner.png`} alt='banner' />
...
<style>
  ...
  main :global(.images.items-image) {
    margin: 50px 0;
  }
  ...
  main :global(.price) {
    ...
    color: var(--fg2);
    text-wrap: nowrap;
    font-family: var(--f-currency);
  }

  main :global(.price span) {
